...
import pl.lotto.Lotto.domain.user.dto.UserRegisterRequestDto;
import pl.lotto.Lotto.domain.user.dto.UserRegisterResultDto;
import pl.lotto.Lotto.domain.user.exception.UserAlreadyExistsException;

import java.util.Set;

import static pl.lotto.Lotto.domain.user.UserMapper.toUserRegisterResultDto;
